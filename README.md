...
service stubs across Python, TypeScript, Rust, C++, Swift, Go, and Kotlin — verified byte-for-byte
...
> built and tested end-to-end across seven languages (88 tests green); APIs may
> still move.
...
| **Codegen required?** | yes for most languages (or descriptor-based reflection) | **no** for Python/TS (IR-driven runtime codec); generated for the compiled targets (Rust/C++/Swift/Go/Kotlin) |
...
client or server from JSON alone, zero codegen); Rust, C++, Swift, Go, and Kotlin get **generated
