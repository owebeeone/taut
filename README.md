...
service stubs across Python, TypeScript, Rust, C++, Swift, Go, Kotlin, and JS — verified byte-for-byte
...
> built and tested end-to-end across eight languages (91 tests green); APIs may
> still move.
...
| **Codegen required?** | yes for most languages (or descriptor-based reflection) | **no** for Python/TS (IR-driven runtime codec); generated for the compiled targets (Rust/C++/Swift/Go/Kotlin/JS) |
...
client or server from JSON alone, zero codegen); Rust, C++, Swift, Go, Kotlin, and JS get **generated
