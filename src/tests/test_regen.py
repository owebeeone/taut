...
from prism.corpus.build import GOLDEN_PATH, IR_JSON_PATH, IR_PATH, generate_golden, reference_values
from prism.gen import cpp as cpp_gen
from prism.gen import rust as rust_gen
...
def test_ir_json_matches_committed():
    ...
    assert IR_JSON_PATH.read_text() == expected, "prism/corpus/griplab.ir.json is stale — re-run build"
